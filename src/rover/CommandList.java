...
public class CommandList {
	...
	public boolean remove(int position) {
		...
		for (int i = 0; i < position && jumper != null; jumper = jumper.getNext())
			i++;
	...
	public boolean moveDown(int position) {
		...
		if (jumper.getNext() == null)
			return false;
		if (jumper.getNext().getNext() == null)
			this.last = jumper;
	...
	public boolean moveUp(int position) {
		...
		if (jumper.getPrev() == null)
			return false;
		if (jumper.getPrev().getPrev() == null)
			this.root = jumper;
